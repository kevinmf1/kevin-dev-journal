...
const config: Config = {
  ...
  url: 'https://kevinmalik.github.io',
  ...
  organizationName: 'kevinmalik', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/kevinmalik/kevin-dev-journal/tree/master/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/kevinmalik/kevin-dev-journal',
          label: 'GitHub',
          position: 'right',
        },
      ],
